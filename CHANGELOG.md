...
* **analyzer/freshness:** pass reproducible builds on the age rule ([#853](https://github.com/trivoallan/regis/issues/853)) ([bbfa9b2](https://github.com/trivoallan/regis/commit/bbfa9b2e298ac108616c3b65e61fcddd21ebe676))
...
* **deps:** update js dependencies (non-major) ([#845](https://github.com/trivoallan/regis/issues/845)) ([3ec877b](https://github.com/trivoallan/regis/commit/3ec877b519fd8119c7ee068e17acd65fcff7c7ea))
...
- **analyzer:** the 'trivy' analyzer is replaced by 'cve' (grype) and 'secrets' (trufflehog); SBOM generation now uses syft. Playbooks using 'provider: trivy' must switch to 'provider: cve' / 'provider: secrets', and 'results.trivy._' becomes 'results.cve._' / 'results.secrets.\*'.
...
- **analyzer:** the 'skopeo' analyzer is renamed to 'oci'. Rule paths results.skopeo._ become results.oci._ and playbooks must use provider: oci. The output schema is redesigned (raw 'inspect' dump removed; size/exposed_ports/ env now declared).
...
- **ci:** reset release-please manifest to v0.28.0 ([#318](https://github.com/trivoallan/regis/issues/318)) ([9563f20](https://github.com/trivoallan/regis/commit/9563f2066de31de665019992e80e097947541832))
- **config:** update launch.json to use correct report-viewer package name ([#281](https://github.com/trivoallan/regis/issues/281)) ([d3c424f](https://github.com/trivoallan/regis/commit/d3c424f8373b21644de3dfc72bdd886b045f8413))
- regenerate alpine playbook example with correct baseUrl ([#283](https://github.com/trivoallan/regis/issues/283)) ([ae1da6f](https://github.com/trivoallan/regis/commit/ae1da6fd5388a0c382cd82753e2418f92c6bfe0c))
...
- **ci:** reset release manifest to v0.26.1 and remove spurious v0.27.0 snapshot ([#242](https://github.com/trivoallan/regis/issues/242)) ([cd4cd6a](https://github.com/trivoallan/regis/commit/cd4cd6a3622ef12f002d26ccd7a16ad39c12ee30))
