...
| **Findings**   | Image is lightweight, runs as a non-root user (if configured), and uses a trusted registry. View the [Live Security Report](/examples/alpine/index.html). |
...
[**Live `regis-cli:latest` Benchmark Report**](/examples/regis-cli/index.html)
...
:::tip
For more information on how to define your own compliance rules, see the [Understand Playbooks](../usage/playbooks.md) guide.
:::
