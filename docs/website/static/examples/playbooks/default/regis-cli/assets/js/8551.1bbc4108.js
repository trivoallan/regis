...
(globalThis.webpackChunk_regis_cli_report_viewer =
  ...
  [8551],
  {
    18043(e, t, a) {
      ...
      (a.d(t, { S: () => l }), (0, a(94553).K2)(l, "populateCommonDb"));
    },
    98551(e, t, a) {
      a.d(t, { diagram: () => v });
      var l = a(59991),
        ...
        h = class {
          ...
          getConfig() {
            const e = o.UI,
              t = (0, o.zj)();
            return (0, i.$t)({ ...e.treemap, ...(t.treemap ?? {}) });
          }
          addNode(e, t) {
            (this.nodes.push(e),
              this.levels.set(e, t),
          ...
          addClass(e, t) {
            ...
            (l &&
              l.forEach((e) => {
                ((0, r.KX)(e) &&
                  (a?.textStyles ? a.textStyles.push(e) : (a.textStyles = [e])),
                  a?.styles ? a.styles.push(e) : (a.styles = [e]));
              }),
      ...
      function m(e) {
        ...
        return (
          e.forEach((e) => {
            ...
            for (
              l.classSelector = e?.classSelector,
                e?.cssCompiledStyles &&
      ...
      (0, c.K2)(m, "buildHierarchy");
      var y = (0, c.K2)((e, t) => {
          (0, n.S)(e, t);
          const a = [];
          for (const r of e.TreemapRows ?? [])
            "ClassDefStatement" === r.$type &&
              t.addClass(r.className ?? "", r.styleText ?? "");
          for (const r of e.TreemapRows ?? []) {
            const e = r.item;
            if (!e) continue;
            const l = r.indent ? parseInt(r.indent) : 0,
              s = f(e),
          ...
          const l = m(a),
            s = (0, c.K2)((e, a) => {
              for (const l of e)
                (t.addNode(l, a),
                  l.children && l.children.length > 0 && s(l.children, a + 1));
            }, "addNodesRecursively");
          s(l, 0);
        }, "populate"),
        f = (0, c.K2)((e) => (e.name ? String(e.name) : ""), "getItemName"),
        u = {
          parser: { yy: void 0 },
          parse: (0, c.K2)(async (e) => {
            try {
              ...
              throw (c.Rm.error("Error parsing treemap:", t), t);
            }
          }, "parse"),
        },
        S = 10,
        g = {
          draw: (0, c.K2)((e, t, a, n) => {
            const i = n.db,
              ...
              m = i.getDiagramTitle(),
              y = i.getRoot(),
              { themeVariables: f } = (0, o.zj)();
            if (!y) return;
            const u = m ? 30 : 0,
              g = (0, l.D)(t),
              x = d.nodeWidth ? d.nodeWidth * S : 960,
              b = d.nodeHeight ? d.nodeHeight * S : 500,
              v = x,
              C = b + u;
            let $;
            (g.attr("viewBox", `0 0 ${v} ${C}`),
              (0, o.a$)(g, C, v, d.useMaxWidth));
            try {
              const e = d.valueFormat || ",";
              if ("$0,0" === e)
                $ = (0, c.K2)((e) => "$" + (0, p.GPZ)(",")(e), "valueFormat");
              ...
              (c.Rm.error("Error creating format function:", G),
                ($ = (0, p.GPZ)(",")));
            }
            const w = (0, p.UMr)().range([
                "transparent",
                f.cScale0,
                f.cScale1,
                f.cScale2,
            ...
            const T = g
              ...
              z = (0, p.hkb)()
                .size([x, b])
                .paddingTop((e) =>
                  e.children && e.children.length > 0 ? 35 : 0,
                )
                .paddingInner(h)
                .paddingLeft((e) =>
                  e.children && e.children.length > 0 ? S : 0,
                )
                .paddingRight((e) =>
                  e.children && e.children.length > 0 ? S : 0,
                )
            ...
            (F.append("rect")
              ...
              F.append("rect")
                ...
                .attr("fill", (e) => w(e.data.name))
                .attr("fill-opacity", 0.6)
                .attr("stroke", (e) => L(e.data.name))
                .attr("stroke-width", 2)
              ...
              F.append("text")
                ...
                .each(function (e) {
                  ...
                  if (n.getComputedTextLength() > r) {
                    ...
                    for (; l.length > 0; ) {
                      if (
                        ((l = a.substring(0, l.length - 1)), 0 === l.length)
                      ) {
                        (t.text(e),
                          n.getComputedTextLength() > r && t.text(""));
                        break;
                      }
                      if ((t.text(l + e), n.getComputedTextLength() <= r))
                        break;
                    }
                  }
                }),
            ...
            const N = z.leaves(),
              D = T.selectAll(".treemapLeafGroup")
                .data(N)
                .enter()
                .append("g")
                .attr(
            ...
            (D.append("rect")
              ...
              .attr("fill", (e) =>
                e.parent ? w(e.parent.data.name) : w(e.data.name),
              )
              .attr(
                "style",
                (e) =>
                  (0, r.GX)({ cssCompiledStyles: e.data.cssCompiledStyles })
                    .nodeStyles,
              )
            ...
            if (
              (D.append("text")
                ...
                .attr("clip-path", (e, a) => `url(#clip-${t}-${a})`)
                .text((e) => e.data.name)
                .each(function (e) {
                  const t = (0, p.Ltv)(this),
                    a = e.x1 - e.x0,
                  ...
                  for (; s.getComputedTextLength() > r && i > 8; )
                    (i--, t.style("font-size", `${i}px`));
                  let o = Math.max(6, Math.min(28, Math.round(0.6 * i))),
                    c = i + 2 + o;
                  for (
                    ;
                    c > n &&
                    i > 8 &&
                    (i--,
                    (o = Math.max(6, Math.min(28, Math.round(0.6 * i)))),
                    !(o < 6 && 8 === i));
                  )
                    (t.style("font-size", `${i}px`), (c = i + 2 + o));
                  (t.style("font-size", `${i}px`),
                    (s.getComputedTextLength() > r || i < 8 || n < i) &&
              ...
              D.append("text")
                ...
                .each(function (e) {
                  ...
                  if (l.empty() || "none" === l.style("display"))
                  ...
                  const i = e.x1 - e.x0,
                    o = e.y1 - e.y0 - 4,
                    c = i - 8;
                  t.node().getComputedTextLength() > c || n + r > o || r < 6
                    ? t.style("display", "none")
                    : t.style("display", null);
                });
            }
            const K = d.diagramPadding ?? 8;
            (0, s.P)(g, K, "flowchart", d?.useMaxWidth || !1);
          }, "draw"),
