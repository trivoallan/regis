  ...
  [2042],
  {
    62042(t, e, n) {
        ...
        l = (function () {
          var t = (0, s.K2)(function (t, e, n, i) {
            ...
            h = {
              ...
              performAction: (0, s.K2)(function (t, e, n, i, s, r, a) {
                var o = r.length - 1;
                switch (s) {
                  case 1:
                    return r[o - 1];
              ...
              parse: (0, s.K2)(function (t) {
                ...
                ("function" == typeof y.yy.parseError
                  ...
                  (0, s.K2)(x, "lex"));
                for (var b, _, k, w, v, K, S, $, E, T = {}; ; ) {
                  if (
                    ((k = n[n.length - 1]),
                    this.defaultActions[k]
                      ? (w = this.defaultActions[k])
                      : (null == b && (b = x()), (w = o[k] && o[k][b])),
                  ...
                  switch (w[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        m &&
                          (T._$.range = [
                            a[a.length - (S || 1)].range[0],
                            a[a.length - 1].range[1],
                          ]),
                        void 0 !==
                          (v = this.performAction.apply(
                            T,
                            [c, h, l, y.yy, w[1], r, a].concat(u),
                          )))
                      )
                        return v;
                      (S &&
      ...
      var u = "",
        ...
        v = (0, s.K2)(function (t) {
          f.find((t) => t.id === p - 1).events.push(t);
        }, "addEvent"),
        K = (0, s.K2)(function (t) {
          const e = {
            section: u,
        ...
        S = (0, s.K2)(function () {
          const t = (0, s.K2)(function (t) {
            return f[t].processed;
          }, "compileTask");
          let e = !0;
          for (const [n, i] of f.entries()) (t(n), (e = e && i.processed));
          return e;
        }, "compileTasks"),
        $ = {
          clear: x,
        ...
        T = (0, s.K2)(function (t, e) {
          ...
          return (
            ...
            (0, s.K2)(c, "sad"),
            (0, s.K2)(l, "ambivalent"),
            e.score > 3 ? o(a) : e.score < 3 ? c(a) : l(a),
            i
          );
        }, "drawFace"),
        I = (0, s.K2)(function (t, e) {
        ...
        C = (0, s.K2)(function (t, e, n) {
          ...
          (s
            ...
            .attr("stroke", "#666"),
            T(s, { cx: i, cy: 300 + 30 * (5 - e.score), score: e.score }));
          const r = H();
          ((r.x = e.x),
            (r.y = e.y),
            (r.fill = e.fill),
      ...
      var z = (0, s.K2)(function (t, e, n, i) {
        ...
        B = (0, s.K2)(function (t, e, n) {
          (t
            ...
            .attr(
              "d",
              `M0 ${e.height - 5} v${10 - e.height} q0,-5 5,-5 h${e.width - 10} q5,0 5,5 v${e.height - 5} H0 Z`,
            ),
            t
              .append("line")
        ...
        F = {
          ...
          initGraphics: j,
          drawNode: z,
          getVirtualNodeHeight: W,
        },
        V = (0, s.K2)(function (t, e, n, a) {
          const o = (0, i.D7)(),
            c = o.timeline?.leftMargin ?? 50;
          s.Rm.debug("timeline", a.db);
          const l = o.securityLevel;
          let h;
          "sandbox" === l && (h = (0, r.Ltv)("#i" + e));
          const d = (
            "sandbox" === l
          ...
          const u = a.db.getTasks(),
            p = a.db.getCommonDb().getDiagramTitle();
          (s.Rm.debug("task", u), F.initGraphics(d));
          const y = a.db.getSections();
          s.Rm.debug("sections", y);
          let g = 0,
            f = 0,
            m = 0,
            x = 0,
          ...
          y.forEach(function (t) {
            const e = {
              ...
              n = F.getVirtualNodeHeight(d, e, o);
            (s.Rm.debug("sectionHeight before draw", n),
              (g = Math.max(g, n + 20)));
          });
          let v = 0,
            K = 0;
          s.Rm.debug("tasks.length", u.length);
          for (const [i, r] of u.entries()) {
            const t = {
                number: i,
                descr: r,
                section: r.section,
              ...
              e = F.getVirtualNodeHeight(d, t, o);
            (s.Rm.debug("taskHeight before draw", e),
              (f = Math.max(f, e + 20)),
              (v = Math.max(v, r.events.length)));
            let n = 0;
            for (const i of r.events) {
              ...
              n += F.getVirtualNodeHeight(d, t, o);
            }
            (r.events.length > 0 && (n += 10 * (r.events.length - 1)),
              (K = Math.max(K, n)));
          }
          (s.Rm.debug("maxSectionHeight before draw", g),
            s.Rm.debug("maxTaskHeight before draw", f),
            y && y.length > 0
              ? y.forEach((t) => {
                  const e = u.filter((e) => e.section === t),
                    n = {
                      number: k,
                      descr: t,
                      section: k,
                  ...
                  const i = d.append("g"),
                    r = F.drawNode(i, n, k, o);
                  (s.Rm.debug("sectionNode output", r),
                    i.attr("transform", `translate(${b}, 50)`),
                    (_ += g + 50),
                    e.length > 0 && G(d, e, k, b, _, f, o, v, K, g, !1),
                    (b += 200 * Math.max(e.length, 1)),
                    (_ = 50),
                    k++);
                })
              : ((w = !1), G(d, u, k, b, _, f, o, v, K, g, !0)));
          const S = d.node().getBBox();
          (s.Rm.debug("bounds", S),
            p &&
              d
                .append("text")
          ...
          (d
            ...
            (0, i.ot)(
              void 0,
              d,
              o.timeline?.padding ?? 50,
              o.timeline?.useMaxWidth ?? !1,
            ));
        }, "draw"),
        G = (0, s.K2)(function (t, e, n, i, r, a, o, c, l, h, d) {
          for (const u of e) {
            const e = {
              descr: u.task,
              section: n,
            ...
            const c = t.append("g").attr("class", "taskWrapper"),
              h = F.drawNode(c, e, n, o).height;
            if (
              (s.Rm.debug("taskHeight after draw", h),
              c.attr("transform", `translate(${i}, ${r})`),
              (a = Math.max(a, h)),
              u.events)
            ) {
        ...
        q = { setConf: (0, s.K2)(() => {}, "setConf"), draw: V },
        J = (0, s.K2)((t) => {
          let e = "";
          for (let n = 0; n < t.THEME_COLOR_LIMIT; n++)
            ((t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n]),
              (0, a.A)(t["lineColor" + n])
                ...
                : (t["lineColor" + n] = (0, c.A)(t["lineColor" + n], 20)));
          for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
            const i = "" + (17 - 3 * n);
