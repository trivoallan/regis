...
(globalThis.webpackChunk_regis_cli_report_viewer =
  ...
  [2674],
  {
    18043(e, t, a) {
      ...
      (a.d(t, { S: () => i }), (0, a(94553).K2)(i, "populateCommonDb"));
    },
    82674(e, t, a) {
      a.d(t, { diagram: () => C });
      var i = a(59991),
        ...
        c = a(34025),
        p = r.UI.pie,
        d = { sections: new Map(), showData: !1, config: p },
        u = d.sections,
        g = d.showData,
        h = structuredClone(p),
        f = (0, s.K2)(() => structuredClone(h), "getConfig"),
        m = (0, s.K2)(() => {
          ((u = new Map()), (g = d.showData), (0, r.IU)());
        }, "clear"),
        w = (0, s.K2)(({ label: e, value: t }) => {
          if (t < 0)
            throw new Error(
          ...
          u.has(e) ||
            (u.set(e, t),
            s.Rm.debug(`added new section: ${e}, with value: ${t}`));
        }, "addSection"),
        S = (0, s.K2)(() => u, "getSections"),
        x = (0, s.K2)((e) => {
          g = e;
        }, "setShowData"),
        D = (0, s.K2)(() => g, "getShowData"),
        T = {
          getConfig: f,
          clear: m,
        ...
        $ = (0, s.K2)((e, t) => {
          ((0, l.S)(e, t),
            t.setShowData(e.showData),
            e.sections.map(t.addSection));
        }, "populateDb"),
        b = {
        ...
        C = {
          ...
          renderer: {
            draw: (0, s.K2)((e, t, a, l) => {
              ...
              S ??= 2;
              const x = d.textPosition,
                D = Math.min(h, g) / 2 - 40,
                T = (0, c.JLW)().innerRadius(0).outerRadius(D),
                $ = (0, c.JLW)()
                  .innerRadius(D * x)
                  .outerRadius(D * x);
              m.append("circle")
              ...
              const A = v.filter(
                  (e) => "0" !== ((e.data.value / k) * 100).toFixed(0),
                ),
                K = (0, c.UMr)(C);
              (m
                .selectAll("mySlices")
                ...
                m
                  ...
                  .attr("transform", (e) => "translate(" + $.centroid(e) + ")")
              ...
              const R = [...b.entries()].map(([e, t]) => ({
                ...
                _ = m
                  ...
                  .attr(
                    "transform",
                    (e, t) =>
                      "translate(216," + (22 * t - (22 * R.length) / 2) + ")",
                  );
              (_.append("rect")
                .attr("width", u)
                .attr("height", u)
                .style("fill", (e) => K(e.label))
                .style("stroke", (e) => K(e.label)),
                _.append("text")
                  .attr("x", 22)
                  .attr("y", 14)
                  .text((e) =>
                    o.getShowData() ? `${e.label} [${e.value}]` : e.label,
                  ));
              const z =
                512 +
                Math.max(
              ...
              (f.attr("viewBox", `0 0 ${z} 450`),
                (0, r.a$)(f, g, z, d.useMaxWidth));
            }, "draw"),
          },
          styles: v,
        };
