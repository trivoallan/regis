...
(globalThis.webpackChunk_regis_cli_report_viewer =
  ...
  [1994],
  {
    31994(t, n, e) {
      ...
      function a(t, n) {
        let e = 0;
        if (void 0 === n) for (let i of t) (i = +i) && (e += i);
        else {
          let i = -1;
          ...
          return (
            (function ({ nodes: t, links: n }) {
              for (const [e, s] of t.entries())
                ((s.index = e), (s.sourceLinks = []), (s.targetLinks = []));
              const i = new Map(t.map((n, e) => [w(n, e, t), n]));
              for (const [e, s] of n.entries()) {
                s.index = e;
                let { source: t, target: n } = s;
                ("object" != typeof t && (t = s.source = x(i, t)),
                  "object" != typeof n && (n = s.target = x(i, n)),
                  t.sourceLinks.push(s),
                  n.targetLinks.push(s));
              }
              if (null != e)
                for (const { sourceLinks: s, targetLinks: r } of t)
                  (s.sort(e), r.sort(e));
            })(l),
            (function ({ nodes: t }) {
              for (const n of t)
                n.value =
                  void 0 === n.fixedValue
                    ? Math.max(a(n.sourceLinks, p), a(n.targetLinks, p))
                    : n.fixedValue;
            })(l),
            (function ({ nodes: t }) {
              const n = t.length;
            ...
            (function (e) {
              const l = (function ({ nodes: t }) {
                ...
                for (const n of t) {
                  const t = Math.max(
                    0,
                    Math.min(e - 1, Math.floor(L.call(null, n, e))),
                  );
                  ((n.layer = t),
                    (n.x0 = i + t * s),
                    (n.x1 = n.x0 + v),
                ...
                if (n) for (const i of o) i.sort(n);
                return o;
              })(e);
              ((t = Math.min(b, (c - s) / (h(l, (t) => t.length) - 1))),
                (function (n) {
                  const e = o(n, (n) => (c - s - (n.length - 1) * t) / a(n, p));
                  for (const i of n) {
                    let n = s;
                    for (const s of i) {
        ...
        function M(t, e, i) {
          for (let s = 1, r = t.length; s < r; ++s) {
            ...
            for (const t of r) {
              let n = 0,
                i = 0;
              for (const { source: e, value: r } of t.targetLinks) {
        ...
        function I(t, e, i) {
          for (let s = t.length - 2; s >= 0; --s) {
            ...
            for (const t of r) {
              let n = 0,
                i = 0;
              for (const { target: e, value: r } of t.sourceLinks) {
        ...
        return (
          ...
          (A.nodeId = function (t) {
            return arguments.length
              ? ((w = "function" == typeof t ? t : u(t)), A)
              : w;
          }),
          (A.nodeAlign = function (t) {
            return arguments.length
              ? ((L = "function" == typeof t ? t : u(t)), A)
              : L;
          }),
          (A.nodeSort = function (t) {
            return arguments.length ? ((n = t), A) : n;
          }),
          (A.nodeWidth = function (t) {
            return arguments.length ? ((v = +t), A) : v;
          }),
          (A.nodePadding = function (n) {
            return arguments.length ? ((b = t = +n), A) : b;
          }),
          (A.nodes = function (t) {
            return arguments.length
              ? ((S = "function" == typeof t ? t : u(t)), A)
              : S;
          }),
          (A.links = function (t) {
            return arguments.length
              ? ((E = "function" == typeof t ? t : u(t)), A)
              : E;
          }),
          ...
          (A.iterations = function (t) {
            return arguments.length ? ((K = +t), A) : K;
          }),
          A
        );
      }
      ...
      E.prototype = K.prototype = {
          ...
          if (null === this._x1)
            ...
            if (Math.abs(h * c - l * a) > L && s) {
              var f = e - r,
                ...
                _ = Math.sqrt(u),
                k =
                  s * Math.tan((b - Math.acos((d + u - p) / (2 * g * _))) / 2),
                x = k / _,
                m = k / g;
              (Math.abs(x - 1) > L &&
                (this._ += "L" + (t + x * a) + "," + (n + x * h)),
                (this._ +=
                  "A" +
                  s +
                  "," +
        ...
        arc: function (t, n, e, i, s, r) {
          ...
          (null === this._x1
            ? (this._ += "M" + l + "," + a)
            : (Math.abs(this._x1 - l) > L || Math.abs(this._y1 - a) > L) &&
              (this._ += "L" + l + "," + a),
            e &&
              (u < 0 && (u = (u % w) + w),
              u > S
      ...
      function C(t) {
        ...
        return (
          ...
          (o.x = function (t) {
            return arguments.length
              ? ((i = "function" == typeof t ? t : I(+t)), o)
              : i;
          }),
          (o.y = function (t) {
            return arguments.length
              ? ((s = "function" == typeof t ? t : I(+t)), o)
              : s;
          }),
      ...
      var U = (function () {
        var t = (0, s.K2)(function (t, n, e, i) {
          ...
          r = {
            ...
            performAction: (0, s.K2)(function (t, n, e, i, s, r, o) {
              var c = r.length - 1;
              switch (s) {
                case 7:
                  const t = i.findOrCreateNode(
                      r[c - 4].trim().replaceAll('""', '"'),
                    ),
                    n = i.findOrCreateNode(
                      r[c - 2].trim().replaceAll('""', '"'),
                    ),
            ...
            parseError: (0, s.K2)(function (t, n) {
              if (!n.recoverable) {
                var e = new Error(t);
                throw ((e.hash = n), e);
              }
            ...
            parse: (0, s.K2)(function (t) {
              ...
              ("function" == typeof d.yy.parseError
                ...
                (0, s.K2)(k, "lex"));
              for (var x, m, v, b, w, L, S, E, K, A = {}; ; ) {
                if (
                  ((v = e[e.length - 1]),
                  this.defaultActions[v]
                    ? (b = this.defaultActions[v])
                    : (null == x && (x = k()), (b = c[v] && c[v][x])),
                ...
                switch (b[0]) {
                  ...
                  case 2:
                    if (
                      ...
                      (A.$ = r[r.length - S]),
                      (A._$ = {
                        first_line: o[o.length - (S || 1)].first_line,
                        last_line: o[o.length - 1].last_line,
                        first_column: o[o.length - (S || 1)].first_column,
                        last_column: o[o.length - 1].last_column,
                      }),
                      _ &&
                        (A._$.range = [
                          o[o.length - (S || 1)].range[0],
                          o[o.length - 1].range[1],
                        ]),
                      void 0 !==
                        (w = this.performAction.apply(
                          A,
                          [l, h, a, d.yy, b[1], r, o].concat(f),
                        )))
                    )
                      return w;
                    (S &&
                      ...
                      (r = r.slice(0, -1 * S)),
                      (o = o.slice(0, -1 * S))),
                      e.push(this.productions_[b[1]][0]),
                      r.push(A.$),
                      o.push(A._$),
                      (E = c[e[e.length - 2]][e[e.length - 1]]),
                      e.push(E));
                    break;
                  case 3:
                    return !0;
          ...
          o = (function () {
            return {
              ...
              unput: (0, s.K2)(function (t) {
                ...
                return (
                  (this.yylloc = {
                    ...
                    last_column: e
                      ? (e.length === i.length ? this.yylloc.first_column : 0) +
                        i[i.length - e.length].length -
                        e[0].length
              ...
              performAction: (0, s.K2)(function (t, n, e, i) {
                switch (e) {
                  case 0:
                  case 1:
      ...
      var F = U,
        ...
        Q = class {
          ...
          static {
            (0, s.K2)(this, "SankeyNode");
          }
        },
        R = (0, s.K2)((t) => {
          t = i.Y2.sanitizeText(t, (0, i.D7)());
          let n = V.get(t);
          return (void 0 === n && ((n = new Q(t)), V.set(t, n), G.push(n)), n);
        }, "findOrCreateNode"),
        B = (0, s.K2)(() => G, "getNodes"),
        Z = (0, s.K2)(() => W, "getLinks"),
        H = (0, s.K2)(
          () => ({
            nodes: G.map((t) => ({ id: t.ID })),
            links: W.map((t) => ({
              source: t.source.ID,
              target: t.target.ID,
              value: t.value,
        ...
        et = (0, s.K2)(function (t, n, e, o) {
          const { securityLevel: c, sankey: l } = (0, i.D7)(),
            a = i.ME.sankey;
          let h;
          "sandbox" === c && (h = (0, r.Ltv)("#i" + n));
          const u =
              "sandbox" === c
                ? (0, r.Ltv)(h.nodes()[0].contentDocument.body)
                : (0, r.Ltv)("body"),
            f =
              "sandbox" === c
                ? u.select(`[id="${n}"]`)
            ...
            y = l?.width ?? a.width,
            d = l?.height ?? a.width,
            p = l?.useMaxWidth ?? a.useMaxWidth,
            g = l?.nodeAlignment ?? a.nodeAlignment,
            _ = l?.prefix ?? a.prefix,
            k = l?.suffix ?? a.suffix,
            x = l?.showValues ?? a.showValues,
            m = o.db.getGraph(),
            b = nt[g];
          v()
            .nodeId((t) => t.id)
          ...
          f.append("g")
            ...
            .join("g")
            .attr("class", "node")
            .attr("id", (t) => (t.uid = tt.next("node-")).id)
          ...
          f.append("g")
            ...
            .data(m.nodes)
            .join("text")
            .attr("x", (t) => (t.x0 < y / 2 ? t.x1 + 6 : t.x0 - 6))
            .attr("y", (t) => (t.y1 + t.y0) / 2)
            .attr("dy", (x ? "0" : "0.35") + "em")
            .attr("text-anchor", (t) => (t.x0 < y / 2 ? "start" : "end"))
            .text(L);
          const S = f
              .append("g")
              .attr("class", "links")
            ...
            E = l?.linkColor ?? "gradient";
          if ("gradient" === E) {
            const t = S.append("linearGradient")
              .attr("id", (t) => (t.uid = tt.next("linearGradient-")).id)
            ...
            (t
              .append("stop")
              .attr("offset", "0%")
              .attr("stop-color", (t) => w(t.source.id)),
              t
                .append("stop")
                .attr("offset", "100%")
                .attr("stop-color", (t) => w(t.target.id)));
          }
          let K;
          switch (E) {
            case "gradient":
              ...
              break;
            case "source":
              K = (0, s.K2)((t) => w(t.source.id), "coloring");
              break;
            case "target":
              K = (0, s.K2)((t) => w(t.target.id), "coloring");
              break;
            default:
              K = E;
          }
        ...
        ot = F.parse.bind(F);
      F.parse = (t) => ot(st(t));
      var ct = { styles: rt, parser: F, db: J, renderer: it };
    },
  },
]);
