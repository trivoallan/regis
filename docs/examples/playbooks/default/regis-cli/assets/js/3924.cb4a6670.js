(globalThis.webpackChunk_regis_cli_report_viewer =
  ...
  [3924],
  {
      ...
      t.exports = (function () {
        ...
        return function (t, e) {
          ...
          n.format = function (t) {
            ...
            var s = this.$utils(),
              r = (t || "YYYY-MM-DDTHH:mm:ssZ").replace(
        ...
        function f(n) {
          ...
          for (
            ...
            var l = r[c],
              ...
              u = d && d[0],
              f = d && d[1];
            r[c] = f ? { regex: u, parser: f } : l.replace(/^\[|\]$/g, "");
          }
          return function (t) {
              ...
              (l && (u = r[2]),
                ...
                (this.$d = (function (t, e, n, i) {
                  try {
                    ...
                    return h
                      ? new Date(
                          Date.UTC(g, p, k, T, x, b, w + 60 * h.offset * 1e3),
                        )
                      : n
                        ? new Date(Date.UTC(g, p, k, T, x, b, w))
                        : ((v = new Date(g, p, k, T, x, b, w)),
                          m && (v = i(v).week(m).toDate()),
                          v);
                  } catch (t) {
                    return new Date("");
                  }
      ...
      t.exports = (function () {
          ...
          p = (function () {
            function m(t, e, n) {
              ...
              if ("string" == typeof t) {
                var s = t.match(l);
                if (s) {
                  var r = s.slice(2).map(function (t) {
            ...
            return (
              ...
              (k.toISOString = function () {
                ...
                var o = g(a, "S"),
                  c =
                    ...
                    r.negative ||
                    o.negative,
                  l = s.format || r.format || o.format ? "T" : "",
                  d =
                    (c ? "-" : "") +
                    "P" +
                    t.format +
              ...
              (k.add = function (t, e, n) {
                var i;
                return (
                  (i = e ? t * d[f(e)] : u(t) ? t.$ms : h(t, this).$ms),
                  h(this.$ms + i * (n ? -1 : 1), this)
                );
              }),
        ...
        return function (n, i, s) {
          ...
          ((i.prototype.add = function (t, e) {
            return u(t) ? v(this, t, 1) : r.bind(this)(t, e);
          }),
            (i.prototype.subtract = function (t, e) {
              return u(t) ? v(this, t, -1) : a.bind(this)(t, e);
            }));
        };
      })();
    },
    ...
    33924(t, e, n) {
        ...
        f = (function () {
          var t = (0, r.K2)(function (t, e, n, i) {
            ...
            C = {
              ...
              performAction: (0, r.K2)(function (t, e, n, i, s, r, a) {
                var o = r.length - 1;
                switch (s) {
                  case 1:
                    return r[o - 1];
                  ...
                  case 16:
                    ...
                    break;
                  case 17:
                    (i.setDateFormat(r[o].substr(11)),
                      (this.$ = r[o].substr(11)));
                    break;
                  case 18:
                    (i.enableInclusiveEndDates(), (this.$ = r[o].substr(18)));
                    break;
                  case 19:
                    (i.TopAxis(), (this.$ = r[o].substr(8)));
                    break;
                  case 20:
                    (i.setAxisFormat(r[o].substr(11)),
                      (this.$ = r[o].substr(11)));
                    break;
                  case 21:
                    (i.setTickInterval(r[o].substr(13)),
                      (this.$ = r[o].substr(13)));
                    break;
                  case 22:
                    (i.setExcludes(r[o].substr(9)), (this.$ = r[o].substr(9)));
                    break;
                  case 23:
                    (i.setIncludes(r[o].substr(9)), (this.$ = r[o].substr(9)));
                    break;
                  case 24:
                    (i.setTodayMarker(r[o].substr(12)),
                      (this.$ = r[o].substr(12)));
                    break;
                  case 27:
                    (i.setDiagramTitle(r[o].substr(6)),
                      (this.$ = r[o].substr(6)));
                    break;
                  case 28:
                    ((this.$ = r[o].trim()), i.setAccTitle(this.$));
                    break;
                  case 29:
                  case 30:
                    ((this.$ = r[o].trim()), i.setAccDescription(this.$));
                    break;
                  case 31:
                    (i.addSection(r[o].substr(8)), (this.$ = r[o].substr(8)));
                    break;
                  case 33:
                    (i.addTask(r[o - 1], r[o]), (this.$ = "task"));
                    break;
                  case 34:
                    ((this.$ = r[o - 1]),
                      i.setClickEvent(r[o - 1], r[o], null));
                    break;
                  case 35:
                    ((this.$ = r[o - 2]),
                      i.setClickEvent(r[o - 2], r[o - 1], r[o]));
                    break;
                  case 36:
                    ((this.$ = r[o - 2]),
                      i.setClickEvent(r[o - 2], r[o - 1], null),
                      i.setLink(r[o - 2], r[o]));
                    break;
                  case 37:
                    ((this.$ = r[o - 3]),
                      i.setClickEvent(r[o - 3], r[o - 2], r[o - 1]),
                      i.setLink(r[o - 3], r[o]));
                    break;
                  case 38:
                    ((this.$ = r[o - 2]),
                      i.setClickEvent(r[o - 2], r[o], null),
                      i.setLink(r[o - 2], r[o - 1]));
                    break;
                  case 39:
                    ((this.$ = r[o - 3]),
                      i.setClickEvent(r[o - 3], r[o - 1], r[o]),
                      i.setLink(r[o - 3], r[o - 2]));
                    break;
                  case 40:
                    ((this.$ = r[o - 1]), i.setLink(r[o - 1], r[o]));
                    break;
                  case 41:
                  case 47:
                    this.$ = r[o - 1] + " " + r[o];
              ...
              parse: (0, r.K2)(function (t) {
                ...
                ("function" == typeof m.yy.parseError
                  ...
                  (0, r.K2)(p, "lex"));
                for (var v, T, x, b, w, $, _, D, C, S = {}; ; ) {
                  if (
                    ((x = n[n.length - 1]),
                    this.defaultActions[x]
                      ? (b = this.defaultActions[x])
                      : (null == v && (v = p()), (b = o[x] && o[x][v])),
                  ...
                  switch (b[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        g &&
                          (S._$.range = [
                            a[a.length - (_ || 1)].range[0],
                            a[a.length - 1].range[1],
                          ]),
                        void 0 !==
                          (w = this.performAction.apply(
                            S,
                            [c, d, l, m.yy, b[1], s, a].concat(h),
                          )))
                      )
                        return w;
                      (_ &&
            ...
            S = (function () {
              return {
                ...
                performAction: (0, r.K2)(function (t, e, n, i) {
                  switch (n) {
                    case 0:
      ...
      f.parser = f;
      var m = f;
      (o.extend(c), o.extend(l), o.extend(d));
      var y,
        k,
        g = { friday: 5, saturday: 6 },
        p = "",
        v = "",
        T = void 0,
        x = "",
        ...
        C = "",
        S = "",
        M = ["active", "done", "crit", "milestone", "vert"],
        K = [],
        E = !1,
        Y = !1,
        L = "sunday",
        ...
        q = (0, r.K2)(function (t) {
          b = t.toLowerCase().split(/[\s,]+/);
        }, "setIncludes"),
        Q = (0, r.K2)(function () {
          return b;
        }, "getIncludes"),
        J = (0, r.K2)(function (t) {
          w = t.toLowerCase().split(/[\s,]+/);
        }, "setExcludes"),
        tt = (0, r.K2)(function () {
          return w;
        }, "getExcludes"),
        ...
        rt = (0, r.K2)(function (t, e, n, i) {
          const s = t.format(e.trim()),
          ...
          return (
            ...
            (!(
              !n.includes("weekends") ||
              (t.isoWeekday() !== g[A] && t.isoWeekday() !== g[A] + 1)
            ) ||
        ...
        lt = (0, r.K2)(function (t, e, n, i) {
          ...
          ((s =
            ...
            (s = s.add(1, "d")),
            (r =
              t.endTime instanceof Date ? o(t.endTime) : o(t.endTime, e, !0)));
          const [a, c] = dt(s, r, e, n, i);
          ((t.endTime = a.toDate()), (t.renderEndTime = c));
        }, "checkTaskDates"),
        dt = (0, r.K2)(function (t, e, n, i, s) {
          let r = !1,
            a = null;
          for (; t <= e; )
            (r || (a = e.toDate()),
        ...
        ut = (0, r.K2)(function (t, e, n) {
          ...
          if (null !== i) {
            let t = null;
            for (const n of i.groups.ids.split(" ")) {
              let e = xt(n);
              void 0 !== e && (!t || e.endTime > t.endTime) && (t = e);
            }
          ...
          {
            (r.Rm.debug("Invalid date:" + n),
              r.Rm.debug("With date format:" + e.trim()));
            const t = new Date(n);
            if (
              void 0 === t ||
              isNaN(t.getTime()) ||
        ...
        ft = (0, r.K2)(function (t, e, n, i = !1) {
          n = n.trim();
          const s = /^until\s+(?<ids>[\d\w- ]+)/.exec(n);
          if (null !== s) {
            let t = null;
            for (const n of s.groups.ids.split(" ")) {
              let e = xt(n);
              void 0 !== e && (!t || e.startTime < t.startTime) && (t = e);
            }
        ...
        mt = 0,
        yt = (0, r.K2)(function (t) {
          return void 0 === t ? "task" + (mt += 1) : t;
        }, "parseId"),
        kt = (0, r.K2)(function (t, e) {
          let n;
          n = ":" === e.substr(0, 1) ? e.substr(1, e.length) : e;
          const i = n.split(","),
            s = {};
          Et(i, s, M);
          for (let a = 0; a < i.length; a++) i[a] = i[a].trim();
          let r = "";
          switch (i.length) {
            case 1:
              ((s.id = yt()), (s.startTime = t.endTime), (r = i[0]));
              break;
            case 2:
              ((s.id = yt()), (s.startTime = ut(void 0, p, i[0])), (r = i[1]));
              break;
            case 3:
              ((s.id = yt(i[0])),
                (s.startTime = ut(void 0, p, i[1])),
                (r = i[2]));
          }
          return (
            r &&
              ((s.endTime = ft(s.startTime, p, r, E)),
              (s.manualEndTime = o(r, "YYYY-MM-DD", !0).isValid()),
              lt(s, p, w, b)),
            s
          );
        }, "compileData"),
        gt = (0, r.K2)(function (t, e) {
          let n;
          n = ":" === e.substr(0, 1) ? e.substr(1, e.length) : e;
          const i = n.split(","),
            s = {};
          Et(i, s, M);
          for (let r = 0; r < i.length; r++) i[r] = i[r].trim();
          switch (i.length) {
            case 1:
              ((s.id = yt()),
        ...
        xt = (0, r.K2)(function (t) {
          const e = vt[t];
          return pt[e];
        }, "findTaskById"),
        bt = (0, r.K2)(function (t, e) {
          const n = {
              section: C,
              type: C,
              description: t,
        ...
        wt = (0, r.K2)(function () {
          const t = (0, r.K2)(function (t) {
            const e = pt[t];
            let n = "";
            switch (pt[t].raw.startTime.type) {
              case "prevTaskEnd": {
                const t = xt(e.prevTaskId);
                e.startTime = t.endTime;
                break;
              }
              case "getStartDate":
                ((n = ut(void 0, p, pt[t].raw.startTime.startData)),
                  n && (pt[t].startTime = n));
            }
            return (
              pt[t].startTime &&
                ((pt[t].endTime = ft(
                  pt[t].startTime,
                  p,
                  pt[t].raw.endTime.data,
                  E,
                )),
                pt[t].endTime &&
                  ((pt[t].processed = !0),
                  (pt[t].manualEndTime = o(
                    pt[t].raw.endTime.data,
                    "YYYY-MM-DD",
                    !0,
                  ).isValid()),
          ...
          let e = !0;
          for (const [n, i] of pt.entries()) (t(n), (e = e && i.processed));
          return e;
        }, "compileTasks"),
        $t = (0, r.K2)(function (t, e) {
          let n = e;
          ("loose" !== (0, s.D7)().securityLevel && (n = (0, a.J)(e)),
        ...
        _t = (0, r.K2)(function (t, e) {
          t.split(",").forEach(function (t) {
            let n = xt(t);
            void 0 !== n && n.classes.push(e);
          });
        }, "setClass"),
        Dt = (0, r.K2)(function (t, e, n) {
        ...
        Kt = {
          ...
          setDateFormat: z,
          getDateFormat: X,
          enableInclusiveEndDates: R,
          endDatesAreInclusive: G,
          enableTopAxis: j,
          topAxisEnabled: U,
          setAxisFormat: F,
          getAxisFormat: W,
      ...
      ((0, r.K2)(Et, "getTaskTags"), o.extend(u));
      var Yt,
        Lt = (0, r.K2)(function () {
        ...
        Ot = (0, r.K2)((t, e) => {
          let n = [...t].map(() => -1 / 0),
            i = [...t].sort(
              (t, e) => t.startTime - e.startTime || t.order - e.order,
            ),
            s = 0;
          for (const r of i)
            for (let t = 0; t < n.length; t++)
              if (r.startTime >= n[t]) {
                ((n[t] = r.endTime), (r.order = t + e), t > s && (s = t));
                break;
              }
          return s;
        }, "getMaxIntersections"),
        ...
        Ft = {
          ...
          renderer: {
            ...
            draw: (0, r.K2)(function (t, e, n, i) {
              const a = (0, s.D7)().gantt,
                c = (0, s.D7)().securityLevel;
              let l;
              "sandbox" === c && (l = (0, h.Ltv)("#i" + e));
              const d =
                  "sandbox" === c
                    ? (0, h.Ltv)(l.nodes()[0].contentDocument.body)
                    : (0, h.Ltv)("body"),
                u = "sandbox" === c ? l.nodes()[0].contentDocument : document,
                f = u.getElementById(e);
              (void 0 === (Yt = f.parentElement.offsetWidth) && (Yt = 1200),
                void 0 !== a.useWidth && (Yt = a.useWidth));
              const m = i.db.getTasks();
              let y = [];
              for (const s of m) y.push(s.type);
              y = S(y);
              const k = {};
              let g = 2 * a.topPadding;
              if (
                "compact" === i.db.getDisplayMode() ||
                "compact" === a.displayMode
              ) {
                const t = {};
                for (const n of m)
                  void 0 === t[n.section]
                ...
                for (const n of Object.keys(t)) {
                  const i = Ot(t[n], e) + 1;
                  ((e += i), (g += i * (a.barHeight + a.barGap)), (k[n] = i));
                }
              } else {
                g += m.length * (a.barHeight + a.barGap);
                for (const t of y) k[t] = m.filter((e) => e.type === t).length;
              }
              f.setAttribute("viewBox", "0 0 " + Yt + " " + g);
              const p = d.select(`[id="${e}"]`),
                v = (0, h.w7C)()
                  .domain([
                    (0, h.jkA)(m, function (t) {
                      return t.startTime;
                    }),
                    (0, h.T9B)(m, function (t) {
                      return t.endTime;
                    }),
                  ])
                  .rangeRound([0, Yt - a.leftPadding - a.rightPadding]);
              function T(t, e) {
                const n = t.startTime,
                  i = e.startTime;
                let s = 0;
              ...
              function x(t, e, n) {
                const s = a.barHeight,
                  ...
                  l = (0, h.m4Y)()
                    ...
                    .range(["#00B9FA", "#F95002"])
                    .interpolate(h.bEH);
                (w(r, o, c, e, n, t, i.db.getExcludes(), i.db.getIncludes()),
                  _(c, o, e, n),
                  b(t, r, o, c, s, l, e),
                  D(r, o),
                  C(c, o, e, n));
              }
              function b(t, n, r, o, c, l, d) {
                t.sort((t, e) => (t.vert === e.vert ? 0 : t.vert ? 1 : -1));
                const u = [...new Set(t.map((t) => t.order))].map((e) =>
                  t.find((t) => t.order === e),
                );
                p.append("g")
                  .selectAll("rect")
                  ...
                  .enter();
                const f = p.append("g").selectAll("rect").data(t).enter(),
                  k = i.db.getLinks();
                (f
                  .append("rect")
                  .attr("id", function (t) {
                  ...
                  .attr("y", function (t, e) {
                    return (
                      (e = t.order),
                      t.vert ? a.gridLineStartPadding : e * n + r
                    );
                  })
                  .attr("width", function (t) {
                    return t.milestone
                      ...
                      : t.vert
                        ? 0.08 * c
                        : v(t.renderEndTime || t.endTime) - v(t.startTime);
                  })
                  .attr("height", function (t) {
                    return t.vert
                      ? m.length * (a.barHeight + a.barGap) + 2 * a.barHeight
                      : c;
                  })
                  ...
                  .attr("class", function (t) {
                    ...
                    for (const [s, r] of y.entries())
                      t.type === r && (n = s % a.numberSectionStyles);
                    let i = "";
                    return (
                      t.active
                        ? t.crit
                          ...
                          : (i = " active")
                        : t.done
                          ? (i = t.crit ? " doneCrit" : " done")
                          : t.crit && (i += " crit"),
                      0 === i.length && (i = " task"),
                      t.milestone && (i = " milestone " + i),
                      t.vert && (i = " vert " + i),
                      (i += n),
                      (i += " " + e),
                      "task" + i
                  ...
                  f
                    ...
                    .attr("x", function (t) {
                      let e = v(t.startTime),
                        n = v(t.renderEndTime || t.endTime);
                      if (
                        (t.milestone &&
                          ((e +=
                            0.5 * (v(t.endTime) - v(t.startTime)) - 0.5 * c),
                          (n = e + c)),
                        t.vert)
                      )
                        return v(t.startTime) + o;
                      const i = this.getBBox().width;
                      return i > n - e
                        ? n + i + 1.5 * a.leftPadding > d
                          ? e + o - 5
                          : n + o + 5
                        : (n - e) / 2 + e + o;
                    })
                    ...
                    .attr("class", function (t) {
                      ...
                      for (const [c, l] of y.entries())
                        t.type === l && (r = c % a.numberSectionStyles);
                      let o = "";
                      return (
                        t.active &&
                          (o = t.crit
                        ...
                        t.done
                          ? (o = t.crit
                              ? o + " doneCritText" + r
                              : o + " doneText" + r)
                          : t.crit && (o = o + " critText" + r),
                        t.milestone && (o += " milestoneText"),
                        t.vert && (o += " vertText"),
                        i > n - e
                          ? n + i + 1.5 * a.leftPadding > d
                            ? s +
                ...
                if ("sandbox" === (0, s.D7)().securityLevel) {
                  ...
                  f.filter(function (t) {
                    ...
                    var e = n.querySelector("#" + t.id),
                      i = n.querySelector("#" + t.id + "-text");
                    const s = e.parentNode;
                    var r = n.createElement("a");
                    (r.setAttribute("xlink:href", k.get(t.id)),
              ...
              function w(t, e, n, s, c, l, d, u) {
                if (0 === d.length && 0 === u.length) return;
                let h, f;
                for (const { startTime: i, endTime: r } of l)
                  ((void 0 === h || i < h) && (h = i),
                    (void 0 === f || r > f) && (f = r));
                if (!h || !f) return;
                if (o(f).diff(o(h), "year") > 5)
                  return void r.Rm.warn(
                ...
                p.append("g")
                  ...
                  .enter()
                  .append("rect")
                  .attr("id", (t) => "exclude-" + t.start.format("YYYY-MM-DD"))
                  .attr("x", (t) => v(t.start.startOf("day")) + n)
                  .attr("y", a.gridLineStartPadding)
                  .attr(
                    "width",
                    (t) => v(t.end.endOf("day")) - v(t.start.startOf("day")),
                  )
                  .attr("height", c - e - a.gridLineStartPadding)
                  .attr("transform-origin", function (e, i) {
                    return (
                      (
                        v(e.start) +
                        n +
                        0.5 * (v(e.end) - v(e.start))
                      ).toString() +
                      "px " +
                      (i * t + 0.5 * c).toString() +
                      "px"
              ...
              function $(t, e, n, i) {
                if (n <= 0 || t > e) return 1 / 0;
                const s = e - t,
                  r = o.duration({ [i ?? "day"]: n }).asMilliseconds();
                return r <= 0 ? 1 / 0 : Math.ceil(s / r);
              }
              function _(t, e, n, s) {
                const o = i.db.getDateFormat(),
                  c = i.db.getAxisFormat();
                let l;
                l = c || ("D" === o ? "%d" : (a.axisFormat ?? "%Y-%m-%d"));
                let d = (0, h.l78)(v)
                  .tickSize(-s + e + a.gridLineStartPadding)
                  .tickFormat((0, h.DCK)(l));
                const u =
                  /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                    i.db.getTickInterval() || a.tickInterval,
                  );
                if (null !== u) {
                  const t = parseInt(u[1], 10);
                  if (isNaN(t) || t <= 0)
                    r.Rm.warn(
                    ...
                    const e = u[2],
                      n = i.db.getWeekday() || a.weekday,
                      s = v.domain(),
                      o = $(s[0], s[1], t, e);
                    if (o > It)
                      r.Rm.warn(
                        `The tick interval "${t}${e}" would generate ${o} ticks, which exceeds the maximum allowed (10000). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                      );
                    else
                      switch (e) {
                        case "millisecond":
                          d.ticks(h.t6C.every(t));
                          break;
                        case "second":
                          d.ticks(h.ucG.every(t));
                          break;
                        case "minute":
                          d.ticks(h.wXd.every(t));
                          break;
                        case "hour":
                          d.ticks(h.Agd.every(t));
                          break;
                        case "day":
                          d.ticks(h.UAC.every(t));
                          break;
                        case "week":
                          d.ticks(At[n].every(t));
                          break;
                        case "month":
                          d.ticks(h.Ui6.every(t));
                      }
                  }
                }
                if (
                  (p
                    .append("g")
                    .attr("class", "grid")
                    .attr("transform", "translate(" + t + ", " + (s - 50) + ")")
                    .call(d)
                    .selectAll("text")
                  ...
                  if (null !== u) {
                    ...
                    if (isNaN(t) || t <= 0)
                      ...
                      const e = u[2],
                        s = i.db.getWeekday() || a.weekday,
                        r = v.domain();
                      if ($(r[0], r[1], t, e) <= It)
                        switch (e) {
                          case "millisecond":
                            n.ticks(h.t6C.every(t));
                            break;
                          case "second":
                            n.ticks(h.ucG.every(t));
                            break;
                          case "minute":
                            n.ticks(h.wXd.every(t));
                            break;
                          case "hour":
                            n.ticks(h.Agd.every(t));
                            break;
                          case "day":
                            n.ticks(h.UAC.every(t));
                            break;
                          case "week":
                            n.ticks(At[s].every(t));
                            break;
                          case "month":
                            n.ticks(h.Ui6.every(t));
                        }
                    }
                  }
                  p.append("g")
              ...
              function D(t, e) {
                let n = 0;
                const i = Object.keys(k).map((t) => [t, k[t]]);
                p.append("g")
                  .selectAll("text")
                  .data(i)
                  .enter()
                  .append(function (t) {
                    const e = t[0].split(s.Y2.lineBreakRegex),
                      n = -(e.length - 1) / 2,
                      i = u.createElementNS(
                    ...
                    for (const [s, r] of e.entries()) {
                      const t = u.createElementNS(
                        "http://www.w3.org/2000/svg",
                        "tspan",
                      );
                      (t.setAttribute("alignment-baseline", "central"),
                        t.setAttribute("x", "10"),
                        s > 0 && t.setAttribute("dy", "1em"),
                        (t.textContent = r),
                        i.appendChild(t));
                    }
                    return i;
                  ...
                  .attr("y", function (s, r) {
                    ...
                    for (let a = 0; a < r; a++)
                      return ((n += i[r - 1][1]), (s[1] * t) / 2 + n * t + e);
                  })
              ...
              function C(t, e, n, s) {
                ...
                (l
                  ...
                  .attr("y2", s - a.titleTopMargin)
                  .attr("class", "today"),
                  "" !== r && l.attr("style", r.replace(/,/g, ";")));
              }
              function S(t) {
                const e = {},
                  n = [];
              ...
              ((0, r.K2)(T, "taskCompare"),
                m.sort(T),
                x(m, Yt, g),
                (0, s.a$)(p, g, Yt, a.useMaxWidth),
                p
                  .append("text")
                ...
                (0, r.K2)(x, "makeGantt"),
                (0, r.K2)(b, "drawRects"),
                (0, r.K2)(w, "drawExcludeDays"),
                (0, r.K2)($, "getEstimatedTickCount"),
                (0, r.K2)(_, "makeGrid"),
                (0, r.K2)(D, "vertLabels"),
                (0, r.K2)(C, "drawToday"),
                (0, r.K2)(S, "checkUnique"));
            }, "draw"),
          },
          styles: (0, r.K2)(
            (t) =>
