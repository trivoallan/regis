...
*   **`set_checklist`**: Appends a Markdown review checklist to the MR description. Checklist items defined with `check_if` conditions may render pre-checked when those conditions pass.
