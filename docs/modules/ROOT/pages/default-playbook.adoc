...
| `https://github.com/trivoallan/regis-cli` (dir: `regis_cli/cookiecutters/mr-evidence`)
| Always generated (no condition). Outputs a `SECURITY_EVIDENCE.md` file in the `.regis-evidence/` directory.
|===
